...
const CommentsonReels = (props) => {
  ...
  const LikeDislikeBidApi = async (id) => {
    ...
    axios({
      method: "get",
      url: 'https://node.bitfuxi.co.uk/api/v1/user/likeDislikeCommentOnReels?',
      params: {
        reelsId: commentListId,
        commentId: id,
      },
      headers: {
        token: value,
  ...
  const CommentListApi = async () => {
    ...
    axios({
      method: "get",
      url: 'https://node.bitfuxi.co.uk/api/v1/user/viewReels?',
      params: {
        reelsId: commentListId,
      },
      headers: {
      ...
      .then(async (response) => {
        if (response.data.responseCode === 200) {
          console.log("====== Comments List Response ======", response.data);
      ...
      .catch((err) => {
        console.log("===== Comments List Api err ======", err.response);
        setLoaderList(false);
      });
  };
  ...
  const CommentOnPostApi = async () => {
    ...
    axios({
      method: "post",
      url: "https://node.bitfuxi.co.uk/api/v1/user/commentOnReels",
      ...
      .then(async (response) => {
        if (response.data.responseCode === 200) {
          console.log("====== Comments on Post Api Response ======", response.data);
          ClearState();
          CommentListApi();
  ...
  const DeleteCommentApi = async (id) => {
    ...
    axios({
      method: "delete",
      url: 'https://node.bitfuxi.co.uk/api/v1/user/deleteCommentOnReels',
  ...
  const ReplyOnCommentApi = async (id) => {
    ...
    axios({
      method: "post",
      url: 'https://node.bitfuxi.co.uk/api/v1/user/commentReplyOnReels',
      data: formData?._parts[0][0],
      headers: {
        token: value,
      },
  ...
  const _renderContent = (section) => {
    console.log("----- footer -----111", section?.reply[0]?._id);
    return (
      <View
        style={[
          ...
          <View style={Styles.CommentSendContainer}>
            ...
            >
              {comments ? (
                ...
                >
                  <Text style={Styles.PostButtonTxt}>
                    {loaderComments ? (
            ...
            <View style={Styles.ReportModalOne}>
              <View style={Styles.ReportModalMainContainer}>
                <View style={{ marginTop: 20 }}>
                  <Text style={Styles.ReportModalAlertTxt}>{"Report"}</Text>
                </View>
                ...
                <View style={{ alignSelf: "center" }}>
                  <TextInput
                    style={[
                      Styles.RemarkInputModalContainer,
                      { color: COLOR.WHITE },
                    ]}
                    multiline={true}
                    onChangeText={(tet) => setGetRemark(tet)}
                ...
                <View style={Styles.ReportModalContainerTwo}>
                  ...
                  <TouchableOpacity
                    style={{ width: 100 }}
                    onPress={() => {
                      ReportOnCommentApi(ParticularId);
                      // setModalVisible1(false), setModalVisibleRemark(true);
                    }}
                  >
...
export default CommentsonReels;
