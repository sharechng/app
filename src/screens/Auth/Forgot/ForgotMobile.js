...
const ForgotMobile = (props) => {
  ...
  const _emailvalidate = (mail) => {
    var emailRegex = /^([0-9]){10}$/;
    if (mail === "") {
      setErrorEmail("*Please enter mobile number.");
    } else if (!(emailRegex.test(mail))) {
      setErrorEmail("*Please enter valid mobile number.");
    } else {
      setErrorEmail(null);
    }
  };
  ...
  const validate = () => {
    //phone validate with country code
        ...
        <View style={[Styles.SubContainer]}>
          ...
          <View style={Styles.InputFieldContainer}>
            <CustomInput
              ...
              keyboardType="numeric" // Newly Added
